...
baseurl <-"https://www.booking.com/reviews/us/hotel/the-ludlow.ko.html?aid=304142;label=gen173nr-1BCAEoggI46AdIM1gEaH2IAQGYARe4ARfIAQzYAQHoAQGIAgGoAgM;sid=fbda4097fd1a54e9a879050610e2ce87;customer_type=total;hp_nav=0;old_page=0;order=featuredreviews;page=2;r_lang=en;rows=75&"
booking.review <- bookingReview(baseurl=baseurl, n=2)
...
mystopwords <- c(stopwords("english"),
                 c("also","among","but","the","even","for","an","this",
                   "four","get","one","said","there","two","three","the","hotel","veri","room","realli","great","area","super","good"))
